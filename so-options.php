...
?>
					<tr id="serverrow-<?php echo $serverKey ?>-<?php echo $groupKey ?>">
						...
						<td>
							Authentication: <?php echo ( true == $soServer['authenticated'] ) ? '<span style="color: #006505;">OK</span>' : ( ( null == $soServer['authenticated'] ) ? '<span style="color: #777777;">unknown</span>' : '<span style="color: #BC0B0B;">failed</span>' ); ?>.<br />
							Remote API: <span style="color: #006505;"><?php echo ( null == $soServer['api'] ) ? '<span style="color: #777777;">unknown</span>' : htmlentities2( $soServer['api'] ); ?></span>.
						</td>
					</tr>
<?php
			}
